...
$(window).load(function() {
    if($('.services-bg').length) {
        $('.bg-text').each(function(key, val) {
            console.log($(val).parent().parent().find('.services-bg img').height());
            $(val).css('min-height', $(val).parent().parent().find('.services-bg img').height());
            $(val).css('max-height', $(val).parent().parent().find('.services-bg img').height());
        })        
    }
})
...
$(document).ready(function() {
    ...
    $(".morelink").click(function(){
        ...
        $(this).prev().find('.morecontent span').toggle();
...
$(document).ready(function() {
    ...
    $('#grid-view').click(function() {
        ...
        if (cols == 2) {
            ...
            $('.product-list').attr('class', 'product-layout product-grid col-lg-3 col-md-3 col-sm-6 col-xs-12');
        }
        ...
        $.ajax({
            ...
            success: function(json) {
                ...
                if (json['success']) {
                    ...
                    setTimeout(function() {
                        $('#cart > a .count').html(json['total']);
                    }, 100);                    

                    $('.mini-cart').load('index.php?route=common/cart/info');
                    setTimeout(function() {
                        $('.show-shopping-cart').addClass('onAdd-item');
                        setTimeout(function() {
                            $('.show-shopping-cart').removeClass('onAdd-item');
                        }, 3000)
                    }, 300);
                }
            },
