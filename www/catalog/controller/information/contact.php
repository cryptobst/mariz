...
class ControllerInformationContact extends Controller {
	...
	public function sendMailInfo() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			...
			$message = "Όνομα: ".$this->request->post['firstName']."\n";
			$message .= "Επώνυμο: ".$this->request->post['lastName']."\n";
			$message .= "Τηλέφωνο: ".$this->request->post['phone']."\n";
			$message .= "Email: ".$this->request->post['email']."\n";
			$message .= "Άτομα για εκδήλωση: ".$this->request->post['party']."\n";
			$message .= "Κιλά τούρτας : ".$this->request->post['cake_weight']."\n";
			$message .= "Μήνυμα : ".$this->request->post['message']."\n";
			...
			$mail->setSubject(html_entity_decode(
				sprintf($this->language->get('email_subject'), $this->request->post['firstName']." ".$this->request->post['lastName']), ENT_QUOTES, 'UTF-8')
			);
